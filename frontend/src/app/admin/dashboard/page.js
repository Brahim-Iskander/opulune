  ...
  const handleDelete = (id) => {
    if (confirm("Êtes-vous sûr de vouloir supprimer ce produit?")) {
      ...
      const deleteProduct = async () => {
        try {
          await axios.delete(
            `https://opulune-4.onrender.com/api/products/deleteproduct/${id}`,
            { headers: { "user-role": user.role } },
          );
        } catch (err) {
          console.error(err);
          ...
          <div className={styles.headerContent}>
            <div className={styles.logoSection}>
              <svg viewBox="0 0 100 100" className={styles.logoIcon}>
                ...
                />
                <path
                  d="M 35 50 Q 50 35 65 50 L 65 80 Q 50 90 35 80 Z"
                  fill="currentColor"
                />
              ...
              <div key={product.id} className={styles.productCard}>
                ...
                <div className={styles.productInfo}>
                  ...
                  <div className={styles.productDetails}>
                    <div className={styles.productPrice}>{product.price} TND</div>
